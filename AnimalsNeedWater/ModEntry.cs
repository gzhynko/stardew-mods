...
public class ModEntry : Mod
{
    ...
    public override void Entry(IModHelper helper)
    {
        ...
        helper.Events.GameLoop.GameLaunched += ModCompatibilityManager.OnGameLaunched;
    ...
    private void OnModMessageReceived(object? sender, ModMessageReceivedEventArgs e)
    {
        ...
        {
            Utils.UpdateBuildingTroughTiles(building);
        }
    }
    ...
    public static void ChangeCoopTexture(Building building, bool empty)
    {
        ...
        {
            building.resetTexture();
            ModHelper.GameContent.InvalidateCache(building.textureName());
        }
    }
