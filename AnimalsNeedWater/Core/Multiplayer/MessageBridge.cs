...
public class MessageBridge
{
    ...
    public void SendStateSyncMessage(HashSet<string> buildings, HashSet<long> fullAnimals, long? receiverId = null)
    {
        var playerIds = receiverId != null ? new long[] { (long)receiverId } : null;
        SendMessageToOwnMod(new StateSyncMessage(buildings, fullAnimals), StateSyncMessageType, playerIds);
    }
    ...
    public void OnModMessageReceived(object? sender, ModMessageReceivedEventArgs e)
    {
        ...
        switch (e.Type)
        {
            ...
            case RequestStateMessageType:
                ...
                SendStateSyncMessage(ModEntry.Data.BuildingsWithWateredTrough, ModEntry.Data.FullAnimals, requestStateMessage.RequesterId);
