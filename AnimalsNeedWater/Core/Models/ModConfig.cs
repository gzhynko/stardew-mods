...
public class ModConfig
{
    ...
    public static void SetUpModConfigMenu(ModConfig config, ModEntry mod)
    {
        ...
        api.AddBoolOption(manifest, () => config.MarnieSellsWaterBowl, val => config.MarnieSellsWaterBowl = (bool)val, () => "Marnie Sells Water Bowl", () => "Whether Marnie sells the water bowl at her shop.");
        api.AddNumberOption(manifest, () => config.MarnieWaterBowlPrice, val => config.MarnieWaterBowlPrice = (int)val, () => "Water Bowl Price", () => "The price of the water bowl object at Marnie's animal shop.", interval: 1.0f);
    }
}